...
import type React from "react" // Import useCallback
...
export const CardItem = ({
  ...
  // Wrapped handleAnimations with useCallback
  ...
  }, [isMouseEntered, translateX, translateY, translateZ, rotateX, rotateY, rotateZ]) // Dependencies for useCallback

  useEffect(() => {
    handleAnimations()
  }, [isMouseEntered, handleAnimations]) // Added handleAnimations to useEffect dependencies
