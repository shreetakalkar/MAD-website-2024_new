...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 left-1/2 -translate-x-1/2 z-[2000] flex max-w-md flex-col gap-2 p-4 sm:p-6",
      className
    )}
    {...props}
  />
