          ...
          <CardItem translateZ="100" className="w-full md:w-1/2 flex flex-col items-center justify-center">
            <div className="relative w-40 h-40 overflow-hidden rounded-xl bg-gray-200 dark:bg-gray-700">
              <Image
                ...
                placeholder="blur"
                blurDataURL="data:image/jpeg;base64,"
                priority={member.role.includes("Principal") || member.role.includes("Chairperson")}
                loading={member.role.includes("Principal") || member.role.includes("Chairperson") ? "eager" : "lazy"}
              />
            </div>
          </CardItem>
