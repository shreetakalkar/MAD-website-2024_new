  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)]">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-64 bg-gray-100 dark:bg-muted p-6 overflow-y-auto">
          <nav>
            <ul className="flex flex-col space-y-6 text-[1.05rem]">
              <li>
                <button
                  onClick={() => setActiveTab("notifications")}
                  className={`text-blue-600 dark:text-white dark:hover:text-gray-300 hover:text-blue-800 ${
        ...
        <main className="flex-1 p-6 overflow-hidden">
          ...
          <div className="h-[calc(100%-4rem)] overflow-hidden">
            {" "}
            {/* Adjust based on your h1 height */}
